...
class Result
{
    ...
    public function paymentSource() 
    {
        ...
        array('card' => Models\PaymentSourceCard::class, 'bank_account' => Models\PaymentSourceBankAccount::class, 'amazon_payment' => Models\PaymentSourceAmazonPayment::class, 'paypal' => Models\PaymentSourcePaypal::class));
    ...
    public function creditNote() 
    {
        ...
        array('line_items' => Models\CreditNoteLineItem::class, 'discounts' => Models\CreditNoteDiscount::class, 'line_item_discounts' => Models\CreditNoteLineItemDiscount::class, 'line_item_tiers' => Models\CreditNoteLineItemTier::class, 'taxes' => Models\CreditNoteTax::class, 'line_item_taxes' => Models\CreditNoteLineItemTax::class, 'linked_refunds' => Models\CreditNoteLinkedRefund::class, 'allocations' => Models\CreditNoteAllocation::class));
        return $credit_note;
    }
    ...
    public function unbilledCharge() 
    {
        ...
        array('tiers' => Models\UnbilledChargeTier::class));
    ...
    public function order() 
    {
        ...
        array('order_line_items' => Models\OrderOrderLineItem::class, 'shipping_address' => Models\OrderShippingAddress::class, 'billing_address' => Models\OrderBillingAddress::class, 'line_item_taxes' => Models\OrderLineItemTax::class, 'line_item_discounts' => Models\OrderLineItemDiscount::class, 'linked_credit_notes' => Models\OrderLinkedCreditNote::class));
        return $order;
    }
    ...
    public function gift() 
    {
        ...
        array('gifter' => Models\GiftGifter::class, 'gift_receiver' => Models\GiftGiftReceiver::class, 'gift_timelines' => Models\GiftGiftTimeline::class));
        return $gift;
    }
    ...
    public function transaction() 
    {
        ...
        array('linked_invoices' => Models\TransactionLinkedInvoice::class, 'linked_credit_notes' => Models\TransactionLinkedCreditNote::class, 'linked_refunds' => Models\TransactionLinkedRefund::class, 'linked_payments' => Models\TransactionLinkedPayment::class));
        return $transaction;
    }
    ...
    public function estimate() 
    {
        ...
        array('subscription_estimate' => Models\SubscriptionEstimate::class, 'invoice_estimate' => Models\InvoiceEstimate::class, 'invoice_estimates' => Models\InvoiceEstimate::class, 'next_invoice_estimate' => Models\InvoiceEstimate::class, 'credit_note_estimates' => Models\CreditNoteEstimate::class, 'unbilled_charge_estimates' => Models\UnbilledCharge::class));
        $estimate->_initDependant($this->_response['estimate'], 'subscription_estimate', 
        array('shipping_address' => Models\SubscriptionEstimateShippingAddress::class, 'contract_term' => Models\SubscriptionEstimateContractTerm::class));
        $estimate->_initDependant($this->_response['estimate'], 'invoice_estimate', 
        array('line_items' => Models\InvoiceEstimateLineItem::class, 'discounts' => Models\InvoiceEstimateDiscount::class, 'taxes' => Models\InvoiceEstimateTax::class, 'line_item_taxes' => Models\InvoiceEstimateLineItemTax::class, 'line_item_tiers' => Models\InvoiceEstimateLineItemTier::class, 'line_item_discounts' => Models\InvoiceEstimateLineItemDiscount::class));
        ...
        array('line_items' => Models\CreditNoteEstimateLineItem::class, 'discounts' => Models\CreditNoteEstimateDiscount::class, 'taxes' => Models\CreditNoteEstimateTax::class, 'line_item_taxes' => Models\CreditNoteEstimateLineItemTax::class, 'line_item_discounts' => Models\CreditNoteEstimateLineItemDiscount::class, 'line_item_tiers' => Models\CreditNoteEstimateLineItemTier::class));
    ...
    public function quote() 
    {
        ...
        array('line_items' => Models\QuoteLineItem::class, 'discounts' => Models\QuoteDiscount::class, 'line_item_discounts' => Models\QuoteLineItemDiscount::class, 'taxes' => Models\QuoteTax::class, 'line_item_taxes' => Models\QuoteLineItemTax::class, 'shipping_address' => Models\QuoteShippingAddress::class, 'billing_address' => Models\QuoteBillingAddress::class));
        return $quote;
    }
    ...
    public function quoteLineGroup() 
    {
        ...
        array('line_items' => Models\QuoteLineGroupLineItem::class, 'discounts' => Models\QuoteLineGroupDiscount::class, 'line_item_discounts' => Models\QuoteLineGroupLineItemDiscount::class, 'taxes' => Models\QuoteLineGroupTax::class, 'line_item_taxes' => Models\QuoteLineGroupLineItemTax::class));
    ...
    public function plan() 
    {
        ...
        array('tiers' => Models\PlanTier::class, 'applicable_addons' => Models\PlanApplicableAddon::class, 'attached_addons' => Models\PlanAttachedAddon::class, 'event_based_addons' => Models\PlanEventBasedAddon::class));
        return $plan;
    }
    ...
    public function addon() 
    {
        ...
        array('tiers' => Models\AddonTier::class));
        return $addon;
    }
    ...
    public function export() 
    {
        ...
        array('download' => Models\ExportDownload::class));
        return $export;
    }
    ...
    public function paymentIntent() 
    {
        ...
        array('payment_attempt' => Models\PaymentIntentPaymentAttempt::class));
